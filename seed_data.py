...
def seed_data():
    ...
    with app.app_context():
        ...
        figma_parts = [
            {"name": "Motor Assembly", "sku": "M-401", "stock": 250, "min": 100, "req": 150, "used": 145, "scrap": 10},
            {"name": "Bearing Unit", "sku": "B-225", "stock": 87, "min": 100, "req": 300, "used": 298, "scrap": 15},
            {"name": "Gear Box", "sku": "GB-150", "stock": 350, "min": 100, "req": 200, "used": 195, "scrap": 12},
            {"name": "Control Panel", "sku": "CP-88", "stock": 28, "min": 100, "req": 100, "used": 102, "scrap": 5},
            {"name": "Hydraulic Pump", "sku": "HP-320", "stock": 180, "min": 50, "req": 80, "used": 78, "scrap": 4},
            {"name": "Sensor Module", "sku": "SM-77", "stock": 92, "min": 150, "req": 400, "used": 395, "scrap": 22},
            {"name": "Cable Harness", "sku": "CH-450", "stock": 225, "min": 200, "req": 350, "used": 347, "scrap": 14},
            {"name": "PCB Board", "sku": "PCB-300", "stock": 35, "min": 80, "req": 120, "used": 118, "scrap": 7},
        ]
